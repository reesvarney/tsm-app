...
def checkIfServerDown():
    if tsm.getUserTSMIdWithSteamID('0') == '502':
        ac.log('TheSetupMarket logs | server returned a 502, trying again.')
        time.sleep(2)
        if tsm.getUserTSMIdWithSteamID('0') == '502':
            ac.log('TheSetupMarket logs | server returned a 502 for a 2nd time, trying one last time.')
            time.sleep(2)
            if tsm.getUserTSMIdWithSteamID('0') == '502':
...
# Needed for some users to get the async functions to work.
...
def showUpdateUserSetupDetails(setupDetails):
    ...
    if setupDetails['track']['ac_code'] == 'baseline':
...
def setRatingStarsColor(rating):
    ...
    if rating == 0:
        ...
        ac.setFontColor(listingTableMisc['ratingDialog1Star']['label'],0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog2Star']['label'], 1, 1, 1, 1)
        ac.setFontColor(listingTableMisc['ratingDialog3Star']['label'], 1, 1, 1, 1)
        ac.setFontColor(listingTableMisc['ratingDialog4Star']['label'], 1, 1, 1, 1)
        ac.setFontColor(listingTableMisc['ratingDialog5Star']['label'], 1, 1, 1, 1)
        ...
        ac.setFontColor(listingTableMisc['ratingDialog1Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog2Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog3Star']['label'], 1, 1, 1, 1)
        ac.setFontColor(listingTableMisc['ratingDialog4Star']['label'], 1, 1, 1, 1)
        ac.setFontColor(listingTableMisc['ratingDialog5Star']['label'], 1, 1, 1, 1)
    elif rating == 3:
        ac.setFontColor(listingTableMisc['ratingDialog1Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog2Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog3Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog4Star']['label'], 1, 1, 1, 1)
        ac.setFontColor(listingTableMisc['ratingDialog5Star']['label'], 1, 1, 1, 1)
    elif rating == 4:
        ac.setFontColor(listingTableMisc['ratingDialog1Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog2Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog3Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog4Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog5Star']['label'], 1, 1, 1, 1)
    elif rating == 5:
        ac.setFontColor(listingTableMisc['ratingDialog1Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog2Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog3Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog4Star']['label'], 0.9098, 0.6, 0.2706, 1)
        ac.setFontColor(listingTableMisc['ratingDialog5Star']['label'], 0.9098, 0.6, 0.2706, 1)
